...
func (l *List) Complete(i int) error {
	...
	// Adjust the index for 0 based indices
	ls[i-1].Done = true
...
// Get opens the provided filename, decodes the JSON data,
// and parses it into the list
...
func (l *List) String() string {
	...
	for k, t := range *l {
		...
		// increase the count to account for zeroed indices
